...
const showUpdateItem = (updateItemID) => {
	...
	updateItemSubmitButton.setAttribute("onClick", "createItem()");
	...
	itemShowUpdateInput.appendChild(updateItemDescriptionLabel);
	itemShowUpdateInput.appendChild(updateItemDescriptionInput);
	itemShowUpdateInput.appendChild(divSpace);
	itemShowUpdateInput.appendChild(updateItemCompleteByLabel);
	itemShowUpdateInput.appendChild(updateItemCompleteByInput);
	itemShowUpdateInput.appendChild(divSpace2);
	itemShowUpdateInput.appendChild(updateItemSubmitButton);
	
	itemShowUpdateInput.appendChild(text);

	itemContainer.appendChild(itemShowUpdateInput);
